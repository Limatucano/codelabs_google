...
public class PulseAnimationsView extends View {
    ...
    public PulseAnimationsView(Context context) {
        this(context,null);
    }

    public PulseAnimationsView(Context context, @Nullable AttributeSet attrs) {
        super(context, attrs);
    }
    @Override
